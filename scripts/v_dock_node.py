...
# rosservice call /v_dock/save "dock_id: 3"
# rosservice call /v_dock/dock "dock_id: 3"
# rosservice call /v_dock/undock "dock_id: 3"
...
class vDockNode:
    def __init__(self):
        ...
        self.dock_distance_tolerance = rospy.get_param('~dock_distance_tolerance', 0.85) # Declare distance metrics in meters
        ...
        if self.robot_pose is not None and (self.docked == False) and (len(self.goal_idx) != 0):
            ...
            # Goal achieved, go to the next goal  
                ...
                if self.dock_status == "pre-dock":
                    ...
                    self.time_prev_call = time.time()
                    self.dock_status = "pre-docked"; rospy.loginfo(str(self.dock_status)+" : Successfully connected to the dock!") 
                elif self.dock_status == "dock":
                    self.docked = True
